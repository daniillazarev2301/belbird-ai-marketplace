...
import { Filter, Grid3X3, List, Star, Heart, ShoppingCart, SlidersHorizontal, X } from "lucide-react";
...
const Catalog = () => {
  ...
  const getCategoryTitle = () => {
    switch (category) {
      case "pets": return "Товары для питомцев";
      case "home": return "Уют и Дом";
      case "garden": return "Сад и Огород";
